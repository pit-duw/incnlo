       subroutine setup_dir(PT_,Q2FAC_,Q2FRAG_,NF_,DELTA_)
C ********************************************************************
...
C ********************************************************************
       ...
       COMMON /CONE/ DELTA,EPSIL
       COMMON /D0CONE/ DELTAI,DELTAA
...
C **********************************************************************
C ***  LEADING ORDER SUBPROCESS CROSS SECTIONS FOR THE UNPOLARIZED CASE
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
       ...
       RETURN
       END
       SUBROUTINE DEFIN(V,W,V1,V2,V3,V4,V5,X,Y,LV,L1V,LW,L1W,
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
C ********************************************************************
C ***  DEFINITIONS OF KINEM. VARIABLES AND ABBREVIATIONS *************
C ********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /KINVAR/ SQS,PT0,ETA0
       COMMON /PTREAL/ PT
...
C ***  LOGARITHMS OF VARIOUS SCALES OVER SHAT
C       LMU=DLOG(Q2MU/SHAT)
       LMU=0.D0   
       LMS=DLOG(Q2FAC/SHAT)
...
C *******************************************
       ...
       FUNCTION FQQB1(V)
C **********************************************************************
C ***  DELTA FUNCTION CONTRIB. TO Q QBAR TO GAMMA GLUON GLUON **********
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
       CALL DEFIN(V,1.D0,V1,V2,V3,V4,V5,X,Y,LV,L1V,LW,L1W,
     #                   LLVW,L1VVW,LMU,LMS,LMSS)
       B0=11.D0/6.D0*NC-NF/3.D0
       TQQB=1.D0-2.D0*V+2.D0*V**2
       C1= - CF/NC*NF*TQQB*(5.D0 - 3.D0*LV)/9.D0 +
     # CF**2/NC*(-(7.D0- PI**2)*TQQB - 2.D0*TQQB*L1V*LV +
     # L1V*V*(2.D0+ V) + LV*V1*(2.D0+ V1)+LV**2*(3.D0*V**2 + 2.D0*V1)+
     #     L1V**2*(2.D0*V + 3.D0*V1**2)) +
     #  CF*((67.D0 - 6.D0*PI**2)*TQQB/18.D0 - L1V*V*V1 -
     #     LV*(11.D0 - 16.D0*V*V1)/6.D0
     #   - L1V**2*(2.D0*V + 3.D0*V1**2)/2.D0 -
     #     LV**2*V*V2/2.D0)
...
C **********************************************************************
       ...
       FUNCTION FQQB2(V,W)
C **********************************************************************
C ***  1/(1-W)_PLUS CONTRIB. TO Q QBAR TO GAMMA GLUON GLUON ************
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
       CALL DEFIN(V,W,V1,V2,V3,V4,V5,X,Y,LV,L1V,LW,L1W,
     #                LLVW,L1VVW,LMU,LMS,LMSS)
       TQQB=1.D0-2.D0*V+2.D0*V**2
       C2=TQQB*(CF/NC*NF/3.D0 - CF*(11.D0 - 12.D0*L1V)/6.D0 -
     #             4.D0*CF**2/NC*(L1V - LV))
       ...
       FUNCTION FQQB3(V,W)
C **********************************************************************
C ***  (LN(1-W)/(1-W))_PLUS CONTRIB. TO Q QBAR TO GAMMA GLUON GLUON ****
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
     ...
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       ...
       FUNCTION FQG1(V)
C **********************************************************************
C ***  DELTA FUNCTION CONTRIB. TO Q GLUON TO GAMMA Q GLUON *************
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
     ...
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       B0=11.D0/6.D0*NC-NF/3.D0
       TQG=2.D0-2.D0*V+V**2
       C1= - LV**2*V*(V**2 - 2.D0*V1)/4.D0+L1V*V*V1/2.D0-
     #  LV*V*V1 + PI**2*V*(1.D0 + V)*V1/4.D0
     #  + L1V**2*V*(1.D0 + V)*V1/4.D0 -
     #  L1V*LV*V*(1.D0 + V)*V1/2.D0 +
     #  CF/NC*(-7.D0*TQG*V/4.D0 + L1V*V*(1.D0 + 2.D0*V)/2.D0 +
     #     PI**2*V*(1.D0 - 4.D0*V + 5.D0*V**2)/6.D0
     #   -LV*V*(3.D0*V**2 - 2.D0*V1)/4.D0+
     #     LV**2*V*(3.D0*V**2 + 2.D0*V1)/2.D0
     #    + L1V**2*V*(V**2 + V1**2)/2.D0 -
     #     L1V*LV*V*(V**2 + V1**2))
       CA=TQG*LMS*(-3.D0*CF/NC/4.D0+NF/(6.D0*NC)
     #           -(11.D0-12.D0*L1V+12.D0*LV)/12.D0)*V
       FQG1=C1+CA
       RETURN
       END
       FUNCTION FQG1MU(V)
...
C **********************************************************************
       ...
       FUNCTION FQG2(V,W)
C **********************************************************************
C ***  1/(1-W)_PLUS CONTRIB. TO Q GLUON TO GAMMA Q GLUON ***************
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
     ...
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       ...
       FUNCTION FQG3(V,W)
C **********************************************************************
C ***  (LN(1-W)/(1-W))_PLUS CONTRIB. TO Q GLUON TO GAMMA Q GLUON *******
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
     ...
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       ...
       FUNCTION FGQ1(V)
C **********************************************************************
C ***  DELTA FUNCTION CONTRIB. TO GLUON Q TO GAMMA Q GLUON *************
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
     ...
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       B0=11.D0/6.D0*NC-NF/3.D0
       TQGC=1.D0+V**2
       C1=( - (L1V*V*V1) + LV*V*V1/2.D0
     #   - L1V**2*(1 - 4.D0*V + V**2)*V1/4.D0 +
     #     PI**2*V*V2*V1/4.D0 - L1V*LV*V*V2*V1/2.D0
     #   + LV**2*V*V2*V1/4.D0) +
     #  CF/NC*(-7.D0*TQGC*V1/4.D0 + 2.D0*L1V*V*V1
     #   + LV*(3.D0 - 4.D0*V - 3.D0*V**2)*V1/4.D0 +
     #     PI**2*(2.D0 - 6.D0*V + 5.D0*V**2)*V1/6.D0 + L1V**2*V1**3 +
     #     LV**2*V1*(3.D0*V**2 + 2.D0*V1)/2.D0
     #   - L1V*LV*V1*(V**2 + V1**2))
       CA=TQGC*LMS*(-11.D0/12.D0 + NF/(6.D0*NC)
     #        - CF/NC*(3.D0 - 4.D0*L1V + 4.D0*LV)/4.D0)*V1
       FGQ1=C1+CA
       RETURN
       END
       FUNCTION FGQ1MU(V)
...
C **********************************************************************
       ...
       FUNCTION FGQ2(V,W)
C **********************************************************************
C ***  1/(1-W)_PLUS CONTRIB. TO GLUON Q TO GAMMA Q GLUON ***************
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
     ...
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       ...
       FUNCTION FGQ3(V,W)
C **********************************************************************
C ***  (LN(1-W)/(1-W))_PLUS CONTRIB. TO GLUON Q TO GAMMA Q GLUON *******
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
     ...
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       ...
       FUNCTION FQQB(V,W)
C **********************************************************************
C ***  REMAINING CONTRIB. TO Q QBAR TO GAMMA GLUON GLUON ***************
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
     ...
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       TQQB=1.D0-2.D0*V+2.D0*V**2
       CC=CF**2/NC*LMS*((1.D0 - 2.D0*V)**2 - (1.D0 - 2.D0*V)*V/X +
     #       V*V1/X**2 + (3.D0*V**2 + V1**2)*W)
       C4=-CC*LV/LMS
       C5=CF**2/NC*L1V*(-2.D0*(2.D0 - X) + 2.D0*(1.D0 + V1**2)/X) +
     #  CF*L1V*((1.D0 + V)*V1 - (1.D0 + V1**2)/X + V*V1*W)
       C6=CF*LW*(1.D0 - V**2 - (1.D0 + V1**2)/X + V*V1*W) +
     #  2.D0*CF**2/NC*LW*(V1**2 + V**2*W**2)/X
       C7=CF*TQQB*LW/(1.D0 - W)
       C8=CF*L1W*(-1.D0 - 2.D0*V*V1 + (1.D0 + V1**2)/X
     #       - (1.D0 - 2.D0*V)*V*W) +
     #  CF**2/NC*L1W*(1.D0 + 8.D0*V*V1 - V*V1/X**2
     #    - (3.D0*v + 4.D0*v1**2)/X -
     #     (1.D0 - 4.D0*V + 8.D0*V**2)*W)
       C9=-4.D0*CF**2/NC*LLVW*V*(V1 - V*W) + CF*LLVW*V*(V2 - V*W)
       C10=CF/NC*(4.D0*CF - NC)*TQQB*(L1V-LLVW)/(1.D0-W)
       C13=CF*NF*V*(V2 - V*W)/(3.D0*NC) + CF**2/NC*
     #   (-4.D0*V*V1 + V*V1/X**2 + V*V1/X + (1.D0 + V - 4.D0*V**2)*W) +
     #  CF*(-(1.D0 - 4.D0*V)*V/(2*X) + V*V1/(2.D0*X**2)
     #     - (2.D0 - 11.D0*V1**2)/6.D0+
     #     (3.D0 - 12.D0*V + 11.D0*V**2)*W/6.D0)
       FQQB=CC+C4+C5+C6+C7+C8+C9+C10+C13
       RETURN
       END
       FUNCTION FQG(V,W)
C **********************************************************************
C ***  REMAINING CONTRIB. TO Q GLUON TO GAMMA Q GLUON ******************
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
     ...
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       TQG=2.D0-2.D0*V+V**2
       CC=CF/NC*LMS*(-(V*V1**2/X**3) + V*V1*(1.D0 + 2.D0*V1)/X**2 -
     #       V*(1.D0 + 2.D0*V1)**2/(2.D0*X) +
     #     V*(V**2 + 6.D0*V1)/2.D0 + V*(2.D0+ V**2)*W/2.D0) +
     #  LMS*(-V + V*(4.D0- 3.D0*V + V**2)/X
     #        + V*V1**2/X**3-V*V1*V2/X**2-
     #  V**2*(2.D0*V**2 + 3.D0*V1)*W/V1 + V**3.D0*(1.D0 + V)*W**2/V1
     #         - V**4*W**3/V1)
       CD=-LMSS*V*(1.D0 + V**2*(1.D0 - W)**2)*(CF/NC*V1**2 + Y*V*W)*
     #            (V1**2 + 2.D0*Y*V*W)/(2.D0*Y**3*V1)
       C4=CF/NC*LV*V*((3.D0*V**2 - 10.D0*V1)/2.D0
     #         + (3.D0- V)**2*V1/(2.D0*Y)
     #           + V1**2/X**3 -
     #     (3.D0 - V)*V1**2/Y**2 + V1**3/Y**3
     #          - V1*(1.D0 + 2.D0*V1)/X**2 +
     #  (1.D0 + 2.D0*V1)**2/(2.D0*X) -(11.D0*V**2 + 2.D0*V1)*W/2.D0
     #     +4.D0*V**2*W**2)+
     #  LV*V*(-(4.D0 - 3.D0*V + V**2)*V1 + (4.D0 - V)*V1**2/Y
     #       - V1**3/X**3 -
     #   V1**3/Y**2 - V1*V2/X + V1**2*V2/X**2 +V*(7.D0+ V**2)*W/2.D0 -
     #      4.D0*V**2*W**2 + 2.D0*V**3*W**3)/V1
       C5=-CF/NC*L1V*V**3*(1.D0 + W) - L1V*V*
     #    ((1.D0 + V)*V1**2 - 4.D0*V*W*(2.D0*X - V*V1
     #      + Y*V*W))/(2.D0*V1)
       C6=-CF/NC*LW*V**3*(1.D0 + 4.D0*W - 2.D0*W**2) +
     #  LW*V*(2.D0*TQG/X + V**2 - 2.D0*V1
     #           - V*W*(3.D0 - 4.D0*V + V*W))/2.D0
       C7=(2.D0*CF - NC)*LW*V*(3.D0*V**2
     #            + 2.D0*V1)/(2.D0*NC*(1.D0 - W))
       C8=C4*L1W/LV-CF/NC*L1W*V**3*(1.D0 - 2.D0*W + 2.D0*W**2) -
     #  L1W*V*(TQG/X - (4.D0 - 3.D0*V)*V*W/2.D0 - V**2*W**2/2.D0)
       C9=CF/NC*LLVW*V**3*(3.D0 - 2.D0*W)*W + LLVW*V*
     #    ((5.D0 - 4.D0*V + V**2)*V1 - V*(8.D0 - 3.D0*V*V1)*W
     #     + V**2*W**2*(7.D0 + V - 4.D0*V*W))/(2.D0*V1)
       C10=(L1V-LLVW)/(1.D0-W)*V*(5.D0 - 4.D0*V + V**2)/2.D0 +
     #      CF/NC*(L1V-LLVW)/(1.D0-W)*V*(V**2 + V1**2)
       C11=CF/NC*L1VVW*V*(-4.D0*V1 + (3.D0 - V)**2*V1/Y -
     #      2.D0*(3.D0 - V)*V1**2/Y**2 +
     #     2.D0*V1**3/Y**3 + V*(2.D0*X + V)*W) +
     #  L1VVW*V*(-11.D0/2.D0 + V + 2.D0*(4.D0 - V)*V1/Y -
     #    2.D0*V1**2/Y**2 + 3.D0*V*W/2.D0 +  V**2*W**2/2.D0)
       C12=-L1VVW/(1.D0-W)*(1.D0 - 2.D0*V)*V/2.D0 -
     #       CF/NC*L1VVW/(1.D0-W)*V*(1.D0 + V**2)
       C13=V*W*(-TQG*V1/2.D0 - 2.D0*V*V1**2/Y**2 -
     #        (9.D0 - 4.D0*V)*V*V1**2/(2.D0*X**2) +
     #      3.D0*V*V1**3/X**3 + V*V1*(1.D0 + 3.D0*V1)/(2.D0*X) +
     #          V*V1*V2/Y + Y*V**2.D0*W)/V1
     #    + CF/NC*(-V*(22.D0 - 35.D0*V + 11.D0*V**2)/(2.D0*X) +
     #     (23.D0 - 16.D0*V)*V*V1/(2.D0*X**2)
     #     - V*(13.D0 - 3.D0*V - 3.D0*V**2)*V1/(2.D0*Y) -
     #     4.D0*V*V1**2/X**3 + (17.D0 - 5.D0*V)*V*V1**2/(2.D0*Y**2)
     #      - 3.D0*V*V1**3/Y**3 +
     #     3.D0*V*(V**2 + 10.D0*V1)/4.D0 + V*(4.D0 - 7.D0*V**2)*W/4.D0)
...
C **********************************************************************
       ...
       DD=V*BFAC*(CF*V1**2 + NC*Y*V*W)*
     #        (Y**2 + V**2*W**2)/(2.D0*NC*Y**3*V1)
       FQGC=DD
       RETURN
       END
       FUNCTION FGQ(V,W)
C **********************************************************************
C ***  REMAINING CONTRIB. TO GLUON Q TO GAMMA Q GLUON ******************
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
     ...
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       TQGC=1.D0+V**2
       HELP1=TQGC*(L1V-LLVW)/(1.D0-W)*V1 - TQGC*LW*V1/(1.D0 - W) +
     #  (-3.D0*CF + 4.D0*CF*L1W + 8.D0*NC*L1W - 4.D0*NC*LLVW
     #  + 4.D0*CF*LV + 4.D0*NC*LV -
     #      4.D0*NC*LW)*V*(1.D0 - V + V**2 - V*W + V**2*W
     #    + V**2*W**2)/(4.D0*NC)
       HELP2= - (CF + NC)*LMS*V*(1.D0 - V + V**2 - V*W
     #                         + V**2*W + V**2*W**2)/NC
...
C **********************************************************************
       ...
       FUNCTION FGG(V,W)
C **********************************************************************
C ***  CONTRIB. TO GLUON GLUON TO GAMMA Q QBAR *************************
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
       CALL DEFIN(V,W,V1,V2,V3,V4,V5,X,Y,LV,L1V,LW,L1W,
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       CC=1.D0/NC*LMS*V*(-(7.D0 - 8.D0*V + 3.D0*V**2)/2.D0
     #         - 2.D0*V1**2/X**2
     #       + 2.D0*V1*V2/X +
     #       (2.D0 - 3.D0*V + 2.D0*V**2)*W
     #         - (3.D0*V**2 + 4.D0*V1)*W**2/2.D0)
       CD=-LMSS*V*(X**2 + V2**2 - 4.D0*V2*V1/Y + 4.D0*V1**2/Y**2)*
     #     (1.D0/NC - (1.D0 - V)*V*W/(CF*Y**2))/2.D0
       C4=1.D0/CF*LV*V**2*V1*(3.D0 - 4.D0*V1**2/Y**4 + 4.D0*V1/(Y*V2)
     #        - 2.D0*(1.D0 + V1**2)/(X*V2) +
     #      4.D0*V1*V2/Y**3 - 2.D0*V2**2/Y**2)*W/2.D0 +
     #  2.D0*1.D0/NC*LV*V*(V1**2/X**2 + V1**2/Y**2
     #            - 2.D0*V1**2/(X*V2) -
     #     2.D0*V1**2/(Y*V2) + (V**2 + V1)*(1.D0 - W + W**2))
       C5=1.D0/CF*L1V*V**2*V1*W*(1.D0 - 2.D0*W
     #      + 2.D0*(1.D0 + V1**2)*W/(X*Y))/2.D0+
     #  1.D0/NC*L1V*V*((4.D0 - 3.D0*V + V**3)/V
     #    - 2.D0*V1*(1.D0 + V1**2)/(X*Y*V)- 2.D0*V*(1.D0 - W)*W)
       C6=1.D0/CF*LW*V*V1*(1.D0 - 3.D0*V1
     #        + 2.D0*V1*(1.D0 + V1**2)/(X*Y))*W/2.D0 +
     #  1.D0/NC*LW*V*(-2.D0*V1*(1.D0 - W)
     #    + 2.D0*V1*(1.D0 + V1**2)*(1.D0 - W)/(X*Y) +  V**2*W**2)
       C8=1.D0/CF*L1W*V*V1*(1.D0 - 2.D0*V*V1**2/Y**4
     #        - (1.D0 + V1**2)/(X*V2)
     #  + 2.D0*V*V1*V2/Y**3 -
     #    V*V2**2/Y**2 - V1*(2.D0*V1 - V*V2)/(Y*V2))*W +
     #  1.D0/NC*L1W*V*(2.D0*V1**2/X**2 + 2.D0*V1**2/Y**2
     #        + 3.D0*(1.D0 + V1**2) -
     #     2.D0*(2.D0 - V**2)*V1/(Y*V*V2) +
     #     2.D0*V1**2*(2.D0*V1 - V*V2)/(X*V*V2) -
     #     4.D0*(V**2 + V1)*W + (3.D0*V**2 + 2.D0*V1)*W**2)
       C9=-1.D0/NC*LLVW*V*(V**2 + V1**2 + V*W*(2.D0*V1 + V*W))
       C11=1.D0/CF*L1VVW*V**2*V1*(-3.D0 - 4.D0*V1**2/Y**4 + 2.D0*V2/Y
     #     + 4.D0*V1*V2/Y**3 -    2.D0*V2**2/Y**2)*W
     #    - 4.D0*1.D0/NC*L1VVW*V**3*V1*(1.D0 - W)*W/Y**2
       C13=1.D0/CF*V*V1*W*(-2.D0*V/Y + 2.D0*(7.D0 - 6.D0*V)*V/Y**2
     #          - 4.D0*V*V1/X**2
     #      + 12.D0*V*V1**2/Y**4 +
     #      V2 + 2.D0*V*V2/X - 12.D0*V*V1*V2/Y**3 - 2.D0*V2*W)/2.D0 +
     #  1.D0/NC*V*(-(3.D0 - V)*V1 - 4.D0*V1**2/X**2 + 4.D0*V1*V2/X +
     #      2.D0*(2.D0 - 3.D0*V + 2.D0*V**2)*W - V2**2*W**2)/2.D0
...
C **********************************************************************
       ...
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
       CALL DEFIN1(V,W,V1,Y,BFAC)
       DD=V*BFAC*(CF*Y**2 - NC*V*V1*W)*
     #  (V1**2 + V**2*W**2)/(2.D0*CF*NC*Y**4)
       FGGC=DD
       RETURN
       END
       FUNCTION FQQ(V,W)
C **********************************************************************
C ***  CONTRIB. TO Q Q TO GAMMA Q Q ************************************
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
       CALL DEFIN(V,W,V1,V2,V3,V4,V5,X,Y,LV,L1V,LW,L1W,
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       CC=CF/NC*LMS*(-(V1**2/X**2) - V1*(5.D0 - 3.D0*V + 2.D0*V**2*V1)
     #  + 2.D0*V1*V2/X -
     #     2.D0*V1*(V**3 - V1**2)*W
     #      -(4.D0*V**2-2.D0*V**3*V1+V1**2)*W**2 +
     #     2.D0*(2 - Y)*V**3*W**3)/(2.D0*V1*W)
       CD=LMSS*(1.D0 + V**2*(1.D0 - W)**2)*(CF/NC**2*Y**2*V*V1*W -
     #     CF/NC*(V1**4 + V*V1**3*W + V**2*V1**2*W**2 + Y*V**3*W**3))/
     #     (Y**2*(1.D0 - V)*W)
       C4=CF/NC**2*LV*V*(-(1.D0 + V)**2 + 4.D0*V1/(Y*V2)
     #     - 2.D0*(1.D0 + V1**2)/(X*V2) +
     #     2.D0*V*(1.D0 + V)*W - V**2*W**2) +
     #  CF/NC*LV*((43.D0 - 33.D0*V + 12.D0*V**2 - 4.D0*V**3)*V1
     #      + V1**2/X**2 -
     #      8.D0*(5.D0 - 4.D0*V + V**2)*V1**2/Y + 4.D0*V1**4/Y**2
     #        - 2.D0*V1*V2/X -
     #      2.D0*V1*(1.D0 + 11.D0*V + V**2*(1.D0 + 2.D0*V1))*W +
     #      (22.D0*V**2 - 18.D0*V**3 + 4.D0*V**4 + V1**2)*W**2
     #      - 4.D0*(2.D0 - Y)*V**3*W**3)/(2.D0*V1*W)
       C5=CF/NC**2*L1V*(V1 - 4.D0*V1/(Y*V2) + V*(1.D0 + V1**2)/(X*V2)
     #      - V**3*(1.D0 - W)**2 -
     #     V*W) + CF/NC*L1V*V*(2.D0*(1.D0 - 2.D0/Y)*V1**2
     #      + V*(3.D0 + V**2)*W -
     #      2.D0*(2.D0 - Y)*V**2*W**2)/V1
       C6=CF/NC*LW*(2.D0*(3.D0 + V**2)*V1 - 4.D0*V1**2/Y -
     #      2.D0*V*(1.D0 + V)*V2*W +
     #      (3.D0 - V)*V**2*W**2)/W +
     #  CF/NC**2*LW*(-(1.D0 + V + V**3) + 4.D0*V1/(Y*V2) -
     #    V*(1.D0 + V1**2)/(X*V2) +
     #     V*(1.D0 + 2.D0*V**2)*W - V**3*W**2)
       C8=C4*L1W/LV-CF/NC*L1W*(X - V)*V*(X + V)/Y -
     #  CF/NC**2*L1W*(1.D0 + V**2*(1.D0 - W)**2)*(V1**2
     #    - V*(1.D0 + V**2*(1.D0 - W))*W)/(X*Y)
       C9=CF/NC*LLVW*V*((1.D0 + V)*V1 - V*(4.D0 - V*V1)*W
     #     + 2.D0*(2.D0 - Y)*V**2*W**2)/V1
       C11=4.D0*CF/NC*L1VVW*V**3*V1*(1.D0 - W)*W/Y**2
       C13=-CF/NC**2*Y**2*V + CF/NC*(-(27.D0-30.D0*V+2.D0*V**2
     #          + 2.D0*V**3)*V1
     #      - V1**2/X**2 +
     #      8.D0*(5.D0 - v)*v1**3/Y-16.D0*v1**4/Y**2
     #    +V1*(1.D0 + 5.D0*V1)/X +
     #      V1*(1.D0+2.D0*(3.D0-V)*V*V1)*W
     #    -V1*(1.D0 - 4.D0*V*(1.D0 + V)*V1)*W**2 +
     #      2.D0*Y*V**3*W**3)/(2.D0*V1*W)
...
C **********************************************************************
       ...
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
       CALL DEFIN1(V,W,V1,Y,BFAC)
       DD=CF*BFAC*( - (Y**2*V*V1*W) +
     #    NC*(Y**4 - 3.D0*Y**2*V*V1*W + V**2*V1**2*W**2))/
     #  (NC**2*Y**2*V1*W)
       FQQC=DD
       RETURN
       END
       FUNCTION FQB(V,W)
C **********************************************************************
C ***  CONTRIB. TO Q QBAR TO GAMMA Q QBAR ******************************
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
     ...
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       CC=CF/NC*LMS*(-V1**2/X**2 - V1*(5.D0 - 3.D0*V + 2.D0*V**2*V1)
     #    + 2.D0*V1*V2/X -
     #     2.D0*V1*(V**3 - V1**2)*W - (4.D0*V**2 - 2.D0*V**3*V1
     #     + V1**2)*W**2 +
     #     2.D0*(2.D0 - Y)*V**3*W**3)/(2.D0*V1*W)
       CD=LMSS*(1.D0 + V**2*(1.D0 - W)**2)*(-CF/NC**2*Y**2*V*V1*W*
     #        (V1**2 - V*V1*W + V**2*W**2) -
     #     CF/NC*(V1**6 + 3.D0*V*V1**5*W + 5.D0*V**2*V1**4*W**2 +
     #        4.D0*V**3*V1**3*W**3 + 5.D0*V**4*V1**2*W**4 +
     #        3.D0*V**5*V1*W**5 + V**6*W**6))/(Y**4*V1*W)
       C4=CF/NC**2*LV*V*(-2.D0 - 2.D0*(1.D0 + V - V**2)*V1/Y - V1**2
     #  + 6.D0*V1**2/Y**2 + V*(5.D0 + V)*W - 3.D0*V**2*W**2) +
     #  CF/NC*LV*((11.D0 - 53.D0*V + 40.D0*V**2 - 12.D0*V**3)*V1
     #    + V1**2/X**2 -
     #      4.D0*(10.D0 - 27.D0*V + 16.D0*V**2 - 3.D0*V**3)*V1**2/Y +
     #      4.D0*V3*V5*V1**4/Y**2
     #     - 8.D0*V4*V1**5/Y**3+
     #      8.D0*V1**6/Y**4 - 2.D0*V1*V2/X - 2.D0*(1.D0 - 5.D0*V
     #      - 7.D0*V**2)*V1*W +
     #      (2.D0*V**3 + 6.D0*V**4 + V1**2)*W**2
     #      - 4.D0*(2.D0 - Y)*V**3*W**3)/(2.D0*V1*W)
       C5=CF/NC**2*L1V*V*(4.D0 - 3.D0*V
     #       - 2.D0*V1*(1.D0 + V**2 + 2.D0*V1)/Y
     #        - V*(X + 2.D0*V1)*W) +
     #  CF/NC*L1V*V*(-2.D0*V1**2 + 4.D0*V1**2/Y + V*(3.D0 + V**2)*W -
     #      2.D0*(2.D0 - Y)*V**2*W**2)/V1
       C6=CF/NC**2*LW*V*(-(5.D0 - 4.D0*V + V**2)
     #     +2.D0*V1*(1.D0+V**2 + 2.D0*V1)/Y
     #    + 2.D0*(1.D0 + X)*V*W) +
     #  CF/NC*LW*(4.D0*V1**2/Y - 2.D0*(1.D0 + V)*V1**2
     #    +2.D0*V*(V**2 + V2)*W -
     #      V**2*(1.D0 + V)*W**2)/W
       C7=-CF/NC**2*LW*(1.D0 + V**2)/(1.D0 - W)
       C8=C4*L1W/LV+L1W*(CF/NC*(2.D0 - Y)*V*(Y - 2.D0*V*W)/Y -
     #    CF/NC**2*V**2*(Y - 2.D0*V*W)*(2.D0*V - W - 3.D0*V*W
     #     + 2.D0*V*W**2)/Y)
       C9=CF/NC**2*LLVW*V*(V2 - (3.D0 - Y)*V*W) -
     #    CF/NC*LLVW*V*((1.D0+ V)*V1 + 2.D0*X*V*W
     #    + V**2*W*(1.D0 + X - Y + 2.D0*V*W**2))/V1
       C10=-CF/NC**2*(L1V-LLVW)/(1.D0-W)*(1.D0 + V1**2)
       C11=2.D0*CF/NC*L1VVW*V*(-2.D0*(4.D0 - 3.D0*V + V**2)
     #     - 2.D0*V3**2*V1**2/Y**2 +
     #     4.D0*V3*V1**3/Y**3 - 4.D0*V1**4/Y**4
     #   + 4.D0*V1*V2**2/Y + V3*V*W)
     #    + CF/NC**2*L1VVW*V*(15.D0 - 13.D0*V + 3.D0*V**2
     #       + 12.D0*V1**2/Y**2 -
     #     12.D0*V1*V2/Y - 7.D0*V*W + 3.D0*V**2*W**2)
       C12=CF/NC**2*L1VVW/(1.D0-W)*(3.D0 - 2.D0*V*V1)
       C13=CF/NC**2*(-3.D0 - (5.D0 - 2.D0*V)*V/X + V*V1/X**2
     #     + 4.D0*V3*V*V1/Y + 2.D0*V*V1**2 -
     #      8.D0*V*V1**2/Y**2 + (V**2 + 2.D0*V**3 + V1**2)*W
     #      + 2.D0*V**3*W**2)/2.D0 +
     #  CF/NC*(-(31.D0 - 54.D0*V + 22.D0*V**2
     #    + 2.D0*V**3)*V1 - V1**2/X**2 +
     #      4.D0*(27.D0 - 19.D0*V)*V1**3/Y
     #    - 4.D0*(37.D0 - 18.D0*V)*V1**4/Y**2 +
     #      24.D0*V4*V1**5/Y**3 - 24.D0*V1**6/Y**4 + V1*V2/X +
     #      V1*(1.D0 + 2.D0*V3*V*V1)*W
     #     -V1*(1.D0 - 4.D0*V**2*V1)*W**2 +
     #      2.D0*Y*V**3*W**3)/(2.D0*V1*W)
...
C **********************************************************************
       ...
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
       CALL DEFIN1(V,W,V1,Y,BFAC)
       DD=CF*BFAC*(2.D0*NC*V**2*V1**2*W**2*(Y**2 - V*V1*W) +
     #  Y**2*(Y**2 - 3.D0*V*V1*W)*(NC*Y**2 + V*V1*W))/(NC**2*Y**4*V1*W)
       FQBC=DD
       RETURN
       END
       FUNCTION FQBS(V,W)
C **********************************************************************
C ***  CONTRIB. TO Q QBAR TO GAMMA QPRIME QBARPRIME ********************
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
       CALL DEFIN(V,W,V1,V2,V3,V4,V5,X,Y,LV,L1V,LW,L1W,
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       CCC=CF/NC*V**2*V1*(-1.D0 - 4.D0*V1**2/Y**4
     #     + 2.D0*V2/Y + 4.D0*V1*V2/Y**3 - 2.D0*V2**2/Y**2)*W
       CD=CCC*LMSS
       C4=-CCC*LV
       C8=-CCC*L1W
       C11=-2.D0*CCC*L1VVW
       C13=2.D0*CF/NC*V**3*V1*(1.D0 - W)*W*
     #       (-1.D0 + 6.D0*V*V1*W/Y**2)/Y**2
...
C **********************************************************************
C ***  CONTRIB. TO Q QPRIME TO GAMMA Q QPRIME **************************
C ***  NOTATION AS IN MANUSCRIPT ***************************************
C ***  CQ, CQS ARE THE CHARGES OF THE INCOMING QUARKS ******************
C **********************************************************************
       IMPLICIT DOUBLE PRECISION (A-H,J-Z)
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
       CALL DEFIN(V,W,V1,V2,V3,V4,V5,X,Y,LV,L1V,LW,L1W,
     #                  LLVW,L1VVW,LMU,LMS,LMSS)
       CC=CF/NC*CQ**2*LMS*V**2*W*(-(3.D0 + V**2)/2.D0 + V1/X
     #    - V1**2/(2.D0*X**2) + (2.D0 - Y)*V*W)/V1
     #     - CF/NC*CQS**2*LMS*(1.D0 + V**2)*V1*(2.D0
     #     - 2.D0*W + W**2)/(2.D0*W)
       CD=CF/NC*LMSS*(1.D0 + V**2*(1.D0 - W)**2)*
     #   (-(CQ**2*V**2*W**2*(V1**2 + 2.D0*Y*V*W)) -
     #     CQS**2*V1**2*(2.D0*V1**2 + V*W*(2.D0*Y - V*W)))/
     #     (2.D0*Y**2*(1.D0 - V)*W)
       C4=2.D0*CF/NC*CQ*CQS*LV*V*(-(5.D0+ V)
     #     + (7.D0 - 4.D0*V + V**2)/Y
     #   + 3.D0*V*W) +
     #  CF/NC*CQ**2*LV*V**2*W*(-2.D0*V1/X - 2.D0*(3.D0 - V)*V1/Y
     #   + V1**2/X**2 +
     #      2.D0*V1**2/Y**2 + 2.D0*(4.D0 - V*V1)
     #    - 4.D0*(2.D0 - Y)*V*W)/(2.D0*V1) +
     #  CF/NC*CQS**2*LV*V1*(2.D0*(2.D0*V**2 + V2)
     #     + 2.D0*V*V1**2*(1.D0 - W)/Y**2 -
     #      (1.D0 + 2.D0*V**2)*(2.D0 - W)*W)/(2.D0*W)
       C5=2.D0*CF/NC*CQ*CQS*(1.D0 - 2.D0/Y)*L1V*V*V1 +
     #  CF/NC*CQ**2*L1V*V**2*W*(3.D0 + V**2 - 2.D0*(2.D0 - Y)*V*W)/V1
       C6=-2.D0*CF/NC*CQ*CQS*(2.D0 - Y)*LW*V**2*W/Y +
     #  CF/NC*CQS**2*LW*V1*(2.D0 + V**2*(2.D0 - 2.D0*W + W**2))/W
       C8=C4*L1W/LV-CF/NC*CQ*CQS*(2.D0 - Y)*L1W*V*(V1 - V*W)/Y
       C9=CF/NC*CQ*CQS*(2.D0 - Y)*LLVW*V - CF/NC*CQ**2*LLVW*V**2*W*
     #    (3.D0 + V**2 - 2.D0*(2.D0 - Y)*V*W)/V1
       C11=2.D0*CF/NC*CQ*CQS*(2.D0 - Y)*L1VVW*V +
     #  2.D0*CF/NC*CQS**2*L1VVW*V*V1*(-V/Y - V1/Y**2) +
     #  2.D0*CF/NC*CQ**2*L1VVW*V**2*(1.D0 - V3/Y + V1/Y**2)*W
       C13=CF/NC*CQ*CQS*(2.D0 - Y)*V*(1.D0/X - 2.D0*V/Y**2)*V1*W +
     #  CF/NC*CQ**2*V**2*W*((1.D0 - 2.D0*V)*V1 - V1**2/X**2
     #     - 4.D0*V1**2/Y**2 +
     #      V1*V2/X + 2.D0*V1*V2/Y + 2.D0*Y*V*W)/(2.D0*V1) +
     #  CF/NC*CQS**2*V1*(2.D0*V4*V1/Y - 4.D0*V1**2/Y**2
     #        - 2.D0*(1.D0 + V*V1) +
     #      (1.D0 + 3.D0*V - 2.D0*V**2)*W -
     #      (1.D0 - 2.D0*V)*(1.D0 + V)*W**2)/(2.D0*W)
...
C **********************************************************************
       ...
       COMMON /PARAMS/ CF,NC,NF,PI,HC2
       CALL DEFIN1(V,W,V1,Y,BFAC)
       DD=CF*BFAC*(CQS**2*V1**2*(Y**2 + V1**2)
     #   + CQ**2*V**2*W**2*(Y**2 + V**2*W**2))/(2.D0*NC*Y**2*V1*W)
       FQSC=DD
       RETURN
       END


      subroutine setup_frag(PT_,Q2FAC_,Q2FRAG_,NF_,DELTA_,S_,GV_,GW_)
 ...
 1    CONTINUE     
      RETURN
      END
      DOUBLE PRECISION FUNCTION AVDELMU(V,S,J0)
C     TERME EN DELTA(1-W)
      ...
      IF (J0.EQ.1) THEN
      AVDELMU = 12*(V**2+1)*(4*GTR*V4+4*GTR*V3-11*V2-11*V1)
     #          /((V-1)**2*V)/18.D0/(8.D0*N**2)   
     ...
     #          /((V-1)**2*V)/18.D0/(8.D0*N**2)   
      ...
      AVDELMU = 12*(2*V**2-2*V+1)*(4*GTR*V4+4*GTR*V3-11*V2-11*V1)
     #          /V/18.D0/(8.D0*N**2)   
      ELSE IF (J0.EQ.6) THEN
      AVDELMU = 12*
     #   (4*GTR*(V**4-2*V**3+4*V**2-3*V+1)*V4-11*(V-1)*V*V4+4*GTR*(V**4-
     #   2*V**3+4*V**2-3*V+1)*V3-11*(V-1)*V*V3-11*(V**4-2*V**3+4*V**2-3*
     #   V+1)*V2+4*GTR*(V-1)*V*V2-11*(V**4-2*V**3+4*V**2-3*V+1)*V1)
     #   /((V-1)**2*V**3)/9.D0/(8.D0*N**2)   
      ...
      AVDELMU = 12*
     #   (4*GTR*(V**4-3*V**3+4*V**2-2*V+1)*V4+11*(V-1)*V**2*V4+4
     #   *GTR*(V**4-3*V**3+4*V**2-2*V+1)*V3+11*(V-1)*V**2*V3-11*(V**4-3*
     #   V**3+4*V**2-2*V+1)*V2-4*GTR*(V-1)*V**2*V2-11*(V**4-3*V**3+4*V**
     #   2-2*V+1)*V1)/((V-1)**2*V)/9.D0/(8.D0*N**2)   
      ELSE IF (J0.EQ.12) THEN
      AVDELMU = (132*N**4*(V-1)**4*(2*
     #   V**2-2*V+1)**2*VC-48*GTR*N**3*(V-1)**4*(2*V**2-2*V+1)**2*VC-132
     #   *N**2*(V-1)**4*(2*V**2-2*V+1)*VC+48*GTR*N*(V-1)**4*(2*V**2-2*V+
     #   1)*VC)/(N**2*(V-1)**5*V**2)/18.D0/(8.D0*N**2)   
      ELSE IF (J0.EQ.13) THEN
      AVDELMU = (-132*N**4*(V-1)**4*(V**2+1)**2*VC+48*GTR*N**3
     #   *(V-1)**4*(V**2+1)**2*VC+132*N**2*(V-1)**6*(V**2+1)*VC-4
     #   8*GTR*N*(V-1)**6*(V**2+1)*VC)/(N**2*(V-1)**6*V**2)/18.D0/
     #   (8.D0*N*VC)    
      ELSE IF (J0.EQ.14) THEN
      AVDELMU = (44*N**4*(V-1)**4*
     ...
     #   *4*V**2*(V**2-2*V+2)*VC)/(N**2*(V-1)**5*V**3)/6.D0/(8.D0*N*VC)
      ...
      AVDELMU = 
     #   (192*GTR*N**2*(V-1)**4*(V**2-V+1)**3*VC-528*N**3*(V-1)**4
     #   *(V**2-V+1)**3*VC)/((V-1)**6*V**3)/9.D0/(8.D0*VC**2)
      ELSE IF (J0.EQ.16) THEN
      AVDELMU = (44*N**4*(V-1)**4*(2*V**2-2*V+1)**2*VC-16
     #   *GTR*N**3*(V-1)**4*(2*V**2-2*V+1)**2*VC-44*N**2*(V-1)**4
     #   *(2*V**2-2*V+1)*VC+16*GTR*N*(V-1)**4*(2*V**2-2*V+1)*VC)
     #   /(N**2*(V-1)**5*V**2)/6.D0/(8.D0*VC**2)
      ENDIF
      RETURN
      END
     ...
     # +.5*AVLO(UN,1.-V,SHD)*(DLOG((1.-V)/V))**2)*(1.-V)/V
      ...
      RETURN
      END
      DOUBLE PRECISION FUNCTION FRESCC1(W,V,X3)
      IMPLICIT REAL*8 (A-H,L-Z)
      COMMON/CONS/PI,GS,GV,GW,N,GTR,CF,VC
      X1=GV*GW/V/W/X3
      X2=(1.-GV)/(1.-V)/X3
      ...
      RETURN
      END
      DOUBLE PRECISION FUNCTION FRESCC2(W,V,X3)
      IMPLICIT REAL*8 (A-H,L-Z)
      COMMON/CONS/PI,GS,GV,GW,N,GTR,CF,VC
      X1=GV*GW/V/W/X3
      X2=(1.-GV)/(1.-V)/X3
...
C    TERME EN DELTA
     ...
     1   TR*(V**2+1)*V3-4*(17*V**2-3*V+8)*V2+(-17*V**2+12*V-29)*V1)-
...
C  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     2*N/VC+HFGQD(V)*(A0(V,S)+A0(1.-V,S))
      ...
      ELSE IF (J0.EQ.3) THEN
      AVDEL =DELW*(3*LOG(1-V)*(V-1)**4*(V**2+1)*(16*GTR*(V**2+1)*V4+16*G
     1   TR*(V**2+1)*V3-4*(8*V**2-3*V+17)*V2+(-29*V**2+12*V-17)*V1)-
     3   80*GTR*(V-1)**4*(V**2+1)**2*(V4+V3)+2*(V-1)**4*(V**2+1)*(2*(18
     4   * PI**2*V**2+85*V**2+85)*V2+(15* PI**2+179)*(V**2+1)*V1)+18*LO
...
C  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     2*N/VC+HFGQD(V)*(A0(V,S)+A0(1.-V,S))
      ...
      ELSE IF (J0.EQ.5) THEN
      AVDEL =DELW*( -80*GTR*(V-1)**3*(2*V**2-2*V+1)**2*(V4+V3)
...
C  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     7   **2-3*V+1)*V1))-80*GTR*
     ;   (V-1)**4*(V**2+1)*(V**2-2*V+2)*((V**4-2*V**3+4*V**2-3*V+1)*V4
     <   +(V**4-2*V**3+4*V**2-3*V+1)*V3+(V-1)*V*V2)+(V-1)**4*(V**2+1)*(
...
C  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     5   PI**2*V**2-716*V**2-6* PI**2*V+358*V-6* PI**2-179)*V1)
     6   -9*LOG(1-V)**2*((V-1)*(V**2+2*V-2)*V4-(V-1)*(5*V**2
...
C  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     4   8*(V-1)**4*(V**2-2*V+2)*VC)
     5   +LOG(1-V)*LOG(V)*(-72*N**4*(V-1)**4*(2*V-1)*(2*V**2-2*V+1
...
C  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     7   *N**2*(V-1)**4*V*(V**2+10*V+1)*VC+72*(V-1)**6*V*VC)
     8   +2*N**4*(V-1)**4*(6*CQ*(PI**2
     ;   +3)*(V**2+1)**2+9*PI**2*V**4+85*V**4+18*PI**2*V**3+9*V**
     <   3+9*PI**2*V**2+188*V**2+9*V+85)*VC-2*N**2*(V-1)**4*(-12
     =   *PI**2*V**4+103*V**4+18*PI**2*V**3-179*V**3+6*CQ*(PI**2
...
C  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     9   *(V-1)**4*V*(2*V-5)*VC)+2*N**4*(V-1)**4*(CQ*(2*PI**2-57
...
C  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     1   *2*(V-1)**4*V*(V**2-V+1)*(5*V**2-2*V+5)*VC)
     2    +4*N**3*(V-1)**4*(378*CQ*(V**2-V+1)**3
     4   +24*PI**2*V**6-134*V**6-72*PI**2*V**5+402*V**5+153*PI**2
     5   *V**4-831*V**4-186*PI**2*V**3+992*V**3+171*PI**2*V**2
...
C     CALCUL DES TERMES CONSTANTS
     ...
     =   V+2)))/(N**2*(V-1)**2*V**2*W**2*(V*W-1)**3*(V*W-V+1)**3)
      ...
      RETURN
      END
      DOUBLE PRECISION FUNCTION STRUVC(W,V,X3,S)
C     CALCUL DES TERMES CONSTANTS
      IMPLICIT REAL*8(A-H,L-Z)
      COMMON /CONS/ PI,GS,GV,GW,N,GTR,CF,VC
      COMMON /KINVAR/ SQS,PT0,ETA
      COMMON /PTREAL/ PT
      COMMON /SCALES/ Q2FAC,Q2MU,Q2FRAG
      COMMON /CONE/ DELTA,EPSIL
      COMMON /EDF/ J0
      ...
      ELSE IF (J0.EQ.2) THEN
      STRUVC=FAC1*( CF/N*(S**2+U**2)/T**2 * PGQ +
     #             CF/N*(S**2+T**2)/U**2 * PGQ )
      ELSE IF (J0.EQ.3) THEN
      STRUVC=FAC1*( CF/N*(S**2+U**2)/T**2 * PQQ )
      ELSE IF (J0.EQ.4) THEN
      STRUVC=FAC1*( CF/N*(S**2+U**2)/T**2 * PGQ +
     #             CF/N*(S**2+T**2)/U**2 * PGQ )
      ELSE IF (J0.EQ.5) THEN
      STRUVC=FAC1*( CF/N*(T**2+U**2)/S**2 * PQQ +
     #        2.D0*CF*(T**2+U**2)*(CF/N/T/U-1.D0/S**2) * PQG )
      ELSE IF (J0.EQ.6) THEN
      STRUVC=FAC1*( CF/N*(T**4+U**4+S**2*(T**2+U**2) -
     #             2.D0/N*U*T*S**2)/U**2/T**2 * PQQ )
      ELSE IF (J0.EQ.7) THEN
      STRUVC=FAC1*( CF/N*(T**4+U**4+S**2*(T**2+U**2) -
     #             2.D0/N*U*T*S**2)/U**2/T**2 * PGQ )
      ELSE IF (J0.EQ.8) THEN
      ...
      STRUVC=FAC2*( (1.D0/U**2-CF/N/S/T)*(S**2+T**2) * PQG )
      ELSE IF (J0.EQ.11) THEN
      STRUVC=FAC1*( 2.D0*CF*(T**2+U**2)*(CF/N/T/U-1.D0/S**2) * PQG +
     #             CF/N*(S**4+T**4+U**2*(S**2+T**2) -
     #             2.D0/N*S*T*U**2)/S**2/T**2 * PQQ )
      ELSE IF (J0.EQ.12) THEN
      STRUVC=FAC1*( 2.D0*CF*(T**2+U**2)*(CF/N/T/U-1.D0/S**2) * PGG +
     #             CF/N*(S**4+T**4+U**2*(S**2+T**2) -
     #             2.D0/N*S*T*U**2)/S**2/T**2 * PGQ +
     #             CF/N*(S**4+U**4+T**2*(S**2+U**2) -
     #             2.D0/N*S*U*T**2)/S**2/U**2 * PGQ +
     #             CF/N*(T**2+U**2)/S**2*2.D0*(NF-1.D0) * PGQ )
      ELSE IF (J0.EQ.13) THEN
      STRUVC=FAC2*( (1.D0/U**2-CF/N/S/T)*(S**2+T**2) * PQG +
     #             (1.D0/T**2-CF/N/S/U)*(S**2+U**2) * PQQ  )
      ELSE IF (J0.EQ.14) THEN
      STRUVC=FAC2*( (1.D0/U**2-CF/N/S/T)*(S**2+T**2) * PGG +
     #             (1.D0/T**2-CF/N/S/U)*(S**2+U**2) * PGQ  )
      ELSE IF (J0.EQ.15) THEN
      STRUVC=FAC3*( N/2.D0/CF*(S**4+T**4+U**4)*
     #            (S**2+T**2+U**2)/S**2/T**2/U**2 * PGG +
     #  1.D0/2.D0/CF*(CF/N/T/U-1.D0/S**2)*(T**2+U**2) * PGQ *2.D0*NF )
      ELSE IF (J0.EQ.16) THEN
      STRUVC=FAC3*( N/2.D0/CF*(S**4+T**4+U**4)*
     #            (S**2+T**2+U**2)/S**2/T**2/U**2 * PQG +
     #  1.D0/2.D0/CF*(CF/N/T/U-1.D0/S**2)*(T**2+U**2) * PQQ )
      ENDIF
      RETURN
      END
...
C
      GPPV(1)=  XUHA*(XDHB+XSHB+XCHB)  *XDUP
...
C*********************************************************************
     ...
     &        (XUBHA*XUHB+XDBHA*XDHB+XCHA*XCHB)*XDSP+
     ...
     &        (XUBHB*XUHA+XDBHB*XDHA+XCHB*XCHA)*XDSP+
     &        (XUBHB*XUHA+XDBHB*XDHA+XSHB*XSHA)*XDCP
C*********************************************************************
      GPPV(6)=XUHA*XUHB*XDUP+XDHA*XDHB*XDDP+XSHA*XSHB*XDSP
     &       +XCHA*XCHB*XDCP
     &       +XUBHA*XUBHB*XDUBP+XDBHA*XDBHB*XDDBP+XSHA*XSHB*XDSP
     &       +XCHA*XCHB*XDCP
      GPPV(6)=GPPV(6)/2.D0
C      GPPC(6)=XUHB*XUHA*XDUP+XDHB*XDHA*XDDP+XSHB*XSHA*XDSP
C     &+XCHB*XCHA*XDCP
C     &+XUBHB*XUBHA*XDUBP+XDBHB*XDBHA*XDDBP+XSHB*XSHA*XDSP
C     &+XCHB*XCHA*XDCP
C      GPPC(6)=GPPC(6)/2.D0
      GPPC(6)=GPPV(6)
C*********************************************************************
      GPPV(7)=(XUHA*XUHB+XDHA*XDHB+XSHA*XSHB+XCHA*XCHB
     &      +XUBHA*XUBHB+XDBHA*XDBHB+XSHA*XSHB+XCHA*XCHB)*XDGP
      GPPV(7)=GPPV(7)/2.D0
C      GPPC(7)=(XUHB*XUHA+XDHB*XDHA+XSHB*XSHA+XCHB*XCHA
C     &      +XUBHB*XUBHA+XDBHB*XDBHA+XSHB*XSHA+XCHB*XCHA)*XDGP
C      GPPC(7)=GPPC(7)/2.D0
      GPPC(7)=GPPV(7)
C*********************************************************************
...
C*********************************************************************
C      GPPV(9)=((XDHA+XSHA+XCHA)*XDUBP+(XUHA+XSHA+XCHA)*XDDBP+
C     &         (XUHA+XDHA+XCHA)*XDSP+(XUHA+XDHA+XSHA)*XDCP+
C     &         (XDBHA+XSHA+XCHA)*XDUBP+(XUBHA+XSHA+XCHA)*XDDBP+
C     &         (XUBHA+XDBHA+XCHA)*XDSP+(XUBHA+XDBHA+XSHA)*XDCP)*XGPROB
C      GPPC(9)=((XDHB+XSHB+XCHB)*XDUBP+(XUHB+XSHB+XCHB)*XDDBP+
C     &         (XUHB+XDHB+XCHB)*XDSP+(XUHB+XDHB+XSHB)*XDCP+
C     &         (XDBHB+XSHB+XCHB)*XDUBP+(XUBHB+XSHB+XCHB)*XDDBP+
C     &         (XUBHB+XDBHB+XCHB)*XDSP+(XUBHB+XDBHB+XSHB)*XDCP)*XGPROA
      GPPV(9)=GPPV(8)
      GPPC(9)=GPPC(8)
C*********************************************************************
      GPPV(10)=(XUHA*XDUBP+XDHA*XDDBP+XSHA*XDSP+XCHA*XDCP+
     &          XUBHA*XDUP+XDBHA*XDDP+XSHA*XDSP+XCHA*XDCP)*XGPROB
      GPPC(10)=(XUHB*XDUBP+XDHB*XDDBP+XSHB*XDSP+XCHB*XDCP+
...
C*********************************************************************
     ...
     &          2.*XSHA*XDSP+2.*XCHA*XDCP)*XGPROB
      GPPC(13)=(XUHB*XDUP+XUBHB*XDUBP+XDHB*XDDP+XDBHB*XDDBP+
     &          2.*XSHB*XDSP+2.*XCHB*XDCP)*XGPROA
C*********************************************************************
...
C      GPPC(15)=XGPROB*XGPROA*XDGP/2.
      GPPC(15)=GPPV(15)
C*********************************************************************
C      GPPV(16)=XGPROA*XGPROB*(XDUP+XDUBP+XDDP+XDDBP+XDSP*2.+XDCP*2.)/2.
C      GPPC(16)=XGPROB*XGPROA*(XDUP+XDUBP+XDDP+XDDBP+XDSP*2.+XDCP*2.)/2.
      GPPV(16)=XGPROA*XGPROB*(XDUP+XDDP+XDSP+XDCP)
C      GPPC(16)=XGPROB*XGPROA*(XDUP+XDDP+XDSP+XDCP)
      GPPC(16)=GPPV(16)
C
      RETURN
      END
